...
def main():
    solver_path = ROOT_DIR / 'model_checkpoints/albert/run2/best_checkpoint_ep254710.pth'
    ...
    torch.save({'preds': preds,
                'golds': golds},
               ROOT_DIR / 'model_checkpoints/albert/run2/best_checkpoint_ep254710.test.preds.golds.pth.tar')
