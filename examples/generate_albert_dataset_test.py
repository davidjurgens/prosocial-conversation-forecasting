...
dataset, _ = CommentsDataset.from_df(data_path=ROOT_DIR / "test.tsv",
                                     subreddit_lookup=subreddit_map)

torch.save(dataset, OUTPUT_DIR / 'cached.test.albert.buffer')
dataset.save_dataset(OUTPUT_DIR / 'cached.test.albert.tensors.dict')
